...
pub fn sha256_update(hash: &mut Vec<u32>, w: &mut Vec<u32>, m: Vec<u8>) {
    assert!(hash.len() == 8);
    assert!(w.len() == 64);
    assert!(m.len() == 64);
...
//pub fn sha224_hash(msg: &mut Vec<u8>) -> Vec<u32> {
...
//}
//
//pub fn sha256_hash(msg: &mut Vec<u8>) -> Vec<u32> {
...
//}
//
//pub fn sha224_dump(hash: Vec<u32>) {
...
//}
//
//pub fn sha256_dump(hash: Vec<u32>) {
...
pub fn sha512_update(hash: &mut Vec<u64>, w: &mut Vec<u64>, m: Vec<u8>) {
    assert!(hash.len() == 8);
    assert!(w.len() == 80);
    assert!(m.len() == 128);
...
impl HashAlgorithm for SHA224 {
    ...
    fn clear(&mut self) {
        self.hash_state = SHA224_INITIAL_HASH.to_vec();
        self.work_state = Vec::from_elem(64, 0u32);
    }

    fn hash_block(&mut self, msg_block: Vec<u8>) {
        sha256_update(&mut self.hash_state, &mut self.work_state, msg_block);
    }
...
pub fn sha224_new() -> SHA224 {
    SHA224{msg_size: 0,
           hash_state: SHA224_INITIAL_HASH.to_vec(),
           work_state: Vec::from_elem(64, 0u32) }
}
...
impl HashAlgorithm for SHA256 {
    ...
    fn clear(&mut self) {
        self.hash_state = SHA256_INITIAL_HASH.to_vec();
        self.work_state = Vec::from_elem(64, 0u32);
    }
...
pub fn sha256_new() -> SHA256 {
    SHA256{msg_size: 0,
           hash_state: SHA256_INITIAL_HASH.to_vec(),
           work_state: Vec::from_elem(64, 0u32) }
}
...
impl HashAlgorithm for SHA384 {
    ...
    fn clear(&mut self) {
        self.hash_state = SHA384_INITIAL_HASH.to_vec();
        self.work_state = Vec::from_elem(80, 0u64);
    }
...
pub fn sha384_new() -> SHA384 {
    SHA384{msg_size: 0,
           hash_state: SHA384_INITIAL_HASH.to_vec(),
           work_state: Vec::from_elem(80, 0u64) }
}
...
impl HashAlgorithm for SHA512 {
    ...
    fn clear(&mut self) {
        self.hash_state = SHA512_INITIAL_HASH.to_vec();
        self.work_state = Vec::from_elem(80, 0u64);
    }
...
pub fn sha512_new() -> SHA512 {
    SHA512{msg_size: 0,
           hash_state: SHA512_INITIAL_HASH.to_vec(),
           work_state: Vec::from_elem(80, 0u64) }
}
...
impl HashAlgorithm for SHA512224 {
    ...
    fn clear(&mut self) {
        self.hash_state = SHA512224_INITIAL_HASH.to_vec();
        self.work_state = Vec::from_elem(80, 0u64);
    }
...
pub fn sha512224_new() -> SHA512224 {
    SHA512224{msg_size: 0,
              hash_state: SHA512224_INITIAL_HASH.to_vec(),
              work_state: Vec::from_elem(80, 0u64) }
}
...
impl HashAlgorithm for SHA512256 {
    ...
    fn clear(&mut self) {
        self.hash_state = SHA512256_INITIAL_HASH.to_vec();
        self.work_state = Vec::from_elem(80, 0u64);
    }
...
pub fn sha512256_new() -> SHA512256 {
    SHA512256{msg_size: 0,
              hash_state: SHA512256_INITIAL_HASH.to_vec(),
              work_state: Vec::from_elem(80, 0u64) }
}
